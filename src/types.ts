...
/**
 * A strategic positioning suggestion generated by the Mission Planner.
 * Stored in Firestore (users/{uid}/missions/{id}) when accepted.
 */
export type MissionLog = {
  ...
  reasonWhy: string;
  badge?: string;
  // Outcome (filled in after the session ends)
  actualEarningsR$?: number;
  actualRides?: number;
  actualKm?: number;
  outcome?: 'success' | 'partial' | 'miss' | 'not_reported';
